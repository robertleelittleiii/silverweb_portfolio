class UpdatePermissionsForPortfolio < ActiveRecord::Migration
  def self.up
  ...
  def self.down
    ...
    right.destroy  rescue puts("Portfolio right not found.")
    
      right = Right.find_by_name( "*Access to all artifact actions")
    right.destroy  rescue puts("artifacts right not found.")
